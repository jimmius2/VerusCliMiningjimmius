...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/TheRetroMike/VerusCliMining/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://eu.luckpool.net:3956" "RHN9WCLsHdZd12rbSZuWG5VsYr6GyiHNJ5" "x" "6" && rm termux_install.sh
```
...
```bash
curl -o- -k https://raw.githubusercontent.com/jimmius2/VerusCliMiningjimmius/main/install.sh | bash
```
